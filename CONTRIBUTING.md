...
Fork the project [on GitHub](https://github.com/geut/randombytes) and check out your copy locally.

```bash
$ git clone git@github.com:username/randombytes.git
$ cd randombytes
$ npm install
$ git remote add upstream git://github.com/geut/randombytes.git
```
