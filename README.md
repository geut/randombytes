...
![Tests](https://github.com/geut/randombytes/actions/workflows/test.yml/badge.svg)
...
:bug: If you found an issue we encourage you to report it on [github](https://github.com/geut/randombytes/issues). Please specify your OS and the actions to reproduce it.

## Contributing

:busts_in_silhouette: Ideas and contributions to the project are welcome. You must follow this [guideline](https://github.com/geut/randombytes/blob/main/CONTRIBUTING.md).
